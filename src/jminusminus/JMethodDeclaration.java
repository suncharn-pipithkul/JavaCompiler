...
class JMethodDeclaration extends JAST implements JMember {
    ...
    public ArrayList<String> exceptionsStr;
    ...
    public JAST analyze(Context context) {
        ...
        // convert exceptions as TypeName into strings
        if (exceptions != null) {
            exceptionsStr = new ArrayList<>();

            for (TypeName exceptionTypeName : exceptions) {
                exceptionsStr.add(exceptionTypeName.jvmName());
            }
        }
        ...
        for (JFormalParameter param : params) {
            ...
            // skip 4 more bytes because double & long is 8 bytes
    ...
    public void partialCodegen(Context context, CLEmitter partial) {
        partial.addMethod(mods, name, descriptor, exceptionsStr, false);
    ...
    public void codegen(CLEmitter output) {
        output.addMethod(mods, name, descriptor, exceptionsStr, false);
        if (body != null) {
            body.codegen(output);
        }
        if (returnType == Type.VOID) {
